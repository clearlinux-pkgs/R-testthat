...
Version  : 3.1.3
Release  : 105
URL      : https://cran.r-project.org/src/contrib/testthat_3.1.3.tar.gz
Source0  : https://cran.r-project.org/src/contrib/testthat_3.1.3.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1648665848
...
/usr/lib64/R/library/testthat/tests/testthat/_snaps/R4.0/snapshot-file/nickname.txt
/usr/lib64/R/library/testthat/tests/testthat/_snaps/R4.0/snapshot.md
/usr/lib64/R/library/testthat/tests/testthat/_snaps/R4.1/snapshot-file/nickname.txt
