...
Version  : 2.3.1
Release  : 73
URL      : https://cran.r-project.org/src/contrib/testthat_2.3.1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/testthat_2.3.1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1575287732
